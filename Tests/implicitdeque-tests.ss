...
(check-expect (deque->list (snoc 1 empty)) (list 1))
(check-expect (deque->list (enqueue 1 (deque 2))) (list 2 1))
(check-expect (deque->list (snoc 1 (deque 2))) (list 1 2))
(check-expect (deque->list (enqueue 1 (deque 2 3))) 
              (list 2 3 1))
(check-expect (deque->list (snoc 1 (deque 2 3))) 
              (list 1 2 3))
