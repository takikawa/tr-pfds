...
(check-expect (find-min (binomialheap less-than? 1 2 3 4)) 1)
(check-expect (find-min (binomialheap less-than? 1 2 3 0)) 0)
(check-expect (find-min (binomialheap less-than? 1 2 -3 4)) -3)
(check-error (find-min (delete-min (binomialheap less-than? 1))) 
             "Heap is empty : find-min")

(check-expect (sorted-list (delete-min (binomialheap less-than? 1 2 3 4)))
              (list 2 3 4))
(check-expect (sorted-list (delete-min (binomialheap less-than? 1 2 3 0)))
              (list 1 2 3))
(check-expect (sorted-list (delete-min (binomialheap less-than? 1 2 -3 4)))
              (list 1 2 4))
(check-error (delete-min (delete-min (binomialheap less-than? 1))) 
             "Heap is empty : delete-min")

(check-expect (sorted-list (delete-min (binomialheap less-than? 1))) (list))
(check-expect (sorted-list (delete-min (binomialheap less-than? 1 -2 -3 -4))) 
              (list -3 -2 1))
...
(check-expect (sorted-list (merge (delete-min (binomialheap less-than? -1))
                                  (binomialheap less-than? 1 -2 -3 -4)))
              (list -4 -3 -2 1))

(check-expect (sorted-list (merge (binomialheap less-than? 1 -2 -3 -4)
                                  (delete-min (binomialheap less-than? -1))))
              (list -4 -3 -2 1))
